...
app.get('/', (req, res) => {
    ...
    const body = `
      <html>
        ...
        <body id="body">
          <div id="container">
            <a href="https://github.com/jonfairbanks/docker-node-app" target="_blank" rel="noopener noreferrer" id='repoLink'>
            ...
            <div id="content">
              <table>
                ...
                <tr>
                  <td>
                    <span id='user-agent'>${req.headers['user-agent']}</span>
                    <br/>
                    <sub>User Agent</sub>
                  </td>
                </tr>
